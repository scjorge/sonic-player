...
import { Disc3, Radio, Mic2, Library, ListMusic, Play, Pause, SkipBack, SkipForward, Volume2, List, ChevronDown, ChevronRight, Plus, X, Trash2, ListX, Heart, PanelLeftClose, PanelLeftOpen, Settings, Tag, ArrowLeft, Navigation, AlertCircle, Download, Settings2, Scissors, LogOut, User } from 'lucide-react';
...
import SongInfoModal from './src/frontend/components/library/SongInfoModal.tsx';
  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden font-sans">
      ...
      >
        ...
        <div className="p-3 border-t border-zinc-800 mt-auto space-y-2">
          {/* User Section */}
          <div className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'justify-between'} px-3 py-2 rounded-lg bg-zinc-800/50`}>
            {!isSidebarCollapsed ? (
              <>
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-zinc-500">{user?.role === 'admin' ? 'Administrador' : 'Usuário'}</p>
                  </div>
                </div>
