  ...
  const renderCell = (song: NaviSong, columnId: ColumnId, index: number) => {
    switch (columnId) {
      ...
      case 'cover': {
        ...
        return (
          ...
          >
            ...
            {song.coverArt ? (
              <img
                src={(song.contentType === 'audio/spotify' || song.contentType === 'audio/tidal' || song.contentType === 'audio/tidal-local') ? song.coverArt : navidromeService.getCoverArtUrl(song.coverArt)}
                alt=""
      ...
      case 'format': {
        ...
        const colorClass = fmt === 'flac' ? 'text-green-400' : fmt === 'mp3' ? 'text-yellow-300' : 'text-zinc-400';
        return (
