  ...
  const renderCell = (song: NaviSong, columnId: ColumnId, index: number) => {
    switch (columnId) {
      ...
      case 'cover': {
        ...
        return (
          ...
          >
            ...
            {song.coverArt ? (
              <img
                src={(song.contentType === 'audio/spotify' || song.contentType === 'audio/tidal' || song.contentType === 'audio/preparation') ? song.coverArt : navidromeService.getCoverArtUrl(song.coverArt)}
                alt=""
      ...
      case 'format': {
        ...
        const colorClass = fmt !== 'flac' && fmt !== 'mp3' ? 'text-red-400' : '';
        return (
