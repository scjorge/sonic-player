...
const SongTable: React.FC<SongTableProps> = ({ 
  ...
  const [columns, setColumns] = useState<ColumnConfig[]>([
    ...
    { id: 'genre', label: 'Gênero', width: 100, visible: true, minWidth: 80 },
    { id: 'comment', label: 'Comentários', width: 150, visible: true, minWidth: 100 },
    { id: 'year', label: 'Ano', width: 60, visible: true, minWidth: 50 },
    { id: 'duration', label: 'Duração', width: 70, visible: true, minWidth: 60 },
    { id: 'track', label: 'Track', width: 50, visible: false, minWidth: 40 }, 
    ...
    { id: 'group', label: 'Grupo', width: 120, visible: false, minWidth: 80 },
